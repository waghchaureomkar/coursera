...
lblInfo=Label(Tops,font=('arial',50,'bold'),text="RESTAURANT BILL CACULATOR",fg="Steel Blue",bd=10,anchor='w')
...
lblIdly= Label(f1, font=('arial', 16, 'bold'),text="Idli",bd=16,anchor="w")
